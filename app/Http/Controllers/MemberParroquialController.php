...
class MemberParroquialController extends Controller
{
    ...
    {
        $model = Members::where('alcance', 'Parroquial')->orderBy('created_at', 'desc')->get();
        // dd($model);
    ...
    public function create()
    {
        ...
        return view('pages.membersParroquial.create', compact(
            'optionsGender',
            'optionsSocialN',
            'optionsScope',
            'seccionales',
    ...
    public function edit($id)
    {
        ...
        $geograficos = Geograficos::all();
        // dd($optionsPositions);
        return view('pages.membersParroquial.edit', compact(
            'member',
            'optionsGender',
            'optionsSocialN',
            'optionsPositions',
