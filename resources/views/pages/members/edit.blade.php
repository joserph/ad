        ...
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members.update', $members->id) }}">
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('cedula') is-invalid @enderror" id="cedula" name="cedula" value="{{ $members->cedula }}">
                    @error('cedula')
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ $members->nombre }}">
                    @error('nombre')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('apellido') is-invalid @enderror" id="apellido" name="apellido" value="{{ $members->apellido }}">
                    @error('apellido')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control mydatepicker @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ $members->fecha_nacimiento }}" placeholder="Seleccione una fecha" autocomplete="off">
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select name="genero" class="form-control select2 @error('genero') is-invalid @enderror" id="genero">
                        ...
                        @foreach ($optionsGender as $value => $label)
                            <option value="{{ $value }}" @selected(old('genero', $members->genero) == $value) >{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('genero')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ $members->telefono }}">
                    @error('telefono')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" value="{{ $members->correo }}">
                    @error('correo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('profesion') is-invalid @enderror" id="profesion" name="profesion" value="{{ $members->profesion }}">
                    @error('profesion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select type="text" class="form-control select2 @error('red_social') is-invalid @enderror" id="red_social" name="red_social">
                        ...
                        @foreach ($optionsSocialN as $value => $label)
                            <option value="{{ $value }}" @selected(old('red_social', $members->red_social) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('red_social')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('usuario_red') is-invalid @enderror" id="usuario_red" name="usuario_red" value="{{ $members->usuario_red }}">
                    @error('usuario_red')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select class="form-control select2 @error('tipo_cargo') is-invalid @enderror"
                        ...
                        @foreach ($optionsTypesPositions as $value => $label)
                            <option value="{{ $value }}" @selected(old('tipo_cargo', $members->tipo_cargo) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('tipo_cargo')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <!-- Cargo publico -->
                <div class="mb-3 col-md-6 col-lg-4 @if($members->cargo_pub == '') d-none @endif" id="cargo_pub">
                    <label for="cargo_pub" class="form-label">Cargo público</label>
                    <input type="text" class="form-control @error('cargo_pub') is-invalid @enderror" id="" name="cargo_pub" value="{{ $members->cargo_pub }}">
                    @error('cargo_pub')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-8 col-lg-6">
                    ...
                    <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="" name="direccion" value="{{ $members->direccion }}">
                    @error('direccion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
