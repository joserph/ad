...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        ...
        <div class="row align-items-center" bis_skin_checked="1">
            ...
            <h4 class="fw-semibold mb-8">Agregar Comite Ejecutivo Parroquiales</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ route('members-parroquial.index') }}">Comite Ejecutivo Parroquiales</a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">Agregar </li>
                </ol>
            </nav>
            </div>
    ...
    <div class="card">
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members-parroquial.store') }}">
                @csrf
                <!-- Cedula -->
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" name="alcance" id="alcance" class="form-control" value="{{ $optionsScope['parroquial'] }}" readonly>
                ...
                <div class="mb-3 col-md-8 col-lg-6">
                    ...
                    <input type="text" class="form-control @error('direccion') is-invalid @enderror" id="" name="direccion" value="{{ old('direccion') }}">
                    @error('direccion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
