...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        ...
        <div class="row align-items-center" bis_skin_checked="1">
            ...
            <h4 class="fw-semibold mb-8">@if($member->id) Editar Comite Ejecutivo Parroquial @else Registrar Miembros @endif</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ route('members-parroquial.index') }}">Comite Ejecutivo Parroquial</a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">@if($member->id) Editar @else Registrar @endif</li>
                </ol>
            </nav>
            </div>
    ...
    <div class="card">
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members-parroquial.update', $member->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('cedula') is-invalid @enderror" id="cedula" name="cedula" value="{{ $member->cedula }}">
                    @error('cedula')
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ $member->nombre }}">
                    @error('nombre')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('apellido') is-invalid @enderror" id="apellido" name="apellido" value="{{ $member->apellido }}">
                    @error('apellido')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control mydatepicker @error('fecha_nacimiento') is-invalid @enderror" id="fecha_nacimiento" name="fecha_nacimiento" value="{{ $member->fecha_nacimiento }}" placeholder="Seleccione una fecha" autocomplete="off">
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select name="genero" class="form-control select2 @error('genero') is-invalid @enderror" id="genero">
                        ...
                        @foreach ($optionsGender as $value => $label)
                            <option value="{{ $value }}" @selected(old('genero', $member->genero) == $value) >{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('genero')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" name="telefono" value="{{ $member->telefono }}">
                    @error('telefono')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="email" class="form-control @error('correo') is-invalid @enderror" id="correo" name="correo" value="{{ $member->correo }}">
                    @error('correo')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('profesion') is-invalid @enderror" id="profesion" name="profesion" value="{{ $member->profesion }}">
                    @error('profesion')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select type="text" class="form-control select2 @error('red_social') is-invalid @enderror" id="red_social" name="red_social">
                        ...
                        @foreach ($optionsSocialN as $value => $label)
                            <option value="{{ $value }}" @selected(old('red_social', $member->red_social) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('red_social')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" class="form-control @error('usuario_red') is-invalid @enderror" id="usuario_red" name="usuario_red" value="{{ $member->usuario_red }}">
                    @error('usuario_red')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" name="alcance" id="alcance" class="form-control" value="{{ $member->alcance }}" readonly>
                    {{-- <select class="form-control select2 @error('alcance') is-invalid @enderror" id="alcance" name="alcance">
                        ...
                        @foreach ($optionsScope as $value => $label)
                            <option value="{{ $value }}" @selected(old('alcance', $member->alcance) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select> --}}
                    @error('alcance')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <!-- Seccional -->
                <div class="mb-3 col-md-6 col-lg-4 @if($member->seccional == '') d-none @endif">
                    ...
                    <select class="form-control select2 @error('seccional') is-invalid @enderror" id="seccional" name="seccional">
                        ...
                        @foreach ($seccionales as $value => $seccional)
                            ...
                            @endphp
                            <option value="{{ $seccional->nombre }}" @selected(old('seccional', $member->seccional) == $seccional->nombre)>{{ $nombre }}</option>
                        @endforeach
                    </select>
                    @error('seccional')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <select class="form-control select2 @error('tipo_cargo') is-invalid @enderror"
                        ...
                        @foreach ($optionsTypesPositions as $value => $label)
                            <option value="{{ $value }}" @selected(old('tipo_cargo', $member->tipo_cargo) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('tipo_cargo')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <!-- Cargo -->
                <div class="mb-3 col-md-6 col-lg-4 @if($member->tipo_cargo != 5) d-none @endif">
                    <label for="cargo" class="form-label">Cargos Administrativos</label>
                    {{ Form::select('cargo', $optionsPositions, $member->cargo, ['class' => 'form-select select2', 'placeholder' => 'Seleccionar', 'id' => 'cargo']) }}
                    {{-- <select class="form-control select2 @error('cargo') is-invalid @enderror" id="cargo" name="cargo">
                        <option value="">Seleccionar</option>
                            @foreach ($optionsPositions as $value => $label)
                                <option value="{{ $value }}" {{ ( $member->cargo == $value) ? 'selected' : '' }}>{{ $label }}</option>";
                            @endforeach
                    </select> --}}
                    @error('cargo')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4 d-none">
                    ...
                    <select class="form-control select2 @error('buro_sec_agraria') is-invalid @enderror" id="buro_sec_agraria" name="buro_sec_agraria">
                        ...
                        @foreach ($optionsBuroSecAgraria as $value => $label)
                            <option value="{{ $value }}" @if ($member->buro_sec_agraria == $value) selected @endif>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('buro')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3 col-md-6 col-lg-4 d-none">
                    ...
                    <select class="form-control select2 @error('buro_sec_asuntos_municipales') is-invalid @enderror" id="buro_sec_asuntos_municipales" name="buro_sec_asuntos_municipales">
                        ...
                        @foreach ($optionsBuroSecAsuntosMunicipales as $value => $label)
                            <option value="{{ $value }}" @selected(old('buro', $member->buro) == $value)>{{ $label }}</option>";
                        @endforeach
                    </select>
                    @error('buro')
                        <div class="invalid-feedback">{{ $message }}</div>
                ...
                <!-- Cargo publico -->
                <div class="mb-3 col-md-6 col-lg-4 @if($member->cargo_pub == '') d-none @endif" id="cargo_pub">
                    <label for="cargo_pub" class="form-label">Cargo público</label>
                    <input type="text" class="form-control @error('cargo_pub') is-invalid @enderror" id="" name="cargo_pub" value="{{ $member->cargo_pub }}">
                    @error('cargo_pub')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
...
@section('page-scripts')
    ...
    <script>
        ...
        window.responseData = @json($member);
