...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        ...
        <div class="row align-items-center" bis_skin_checked="1">
            ...
            <h4 class="fw-semibold mb-8">Agregar Comite Ejecutivo Municipales</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ route('members-seccional.index') }}">Comite Ejecutivo Municipales</a>
                    </li>
    ...
    <div class="card">
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members-municipal.store') }}">
                @csrf
                <!-- Cedula -->
                ...
                <div class="mb-3 col-md-6 col-lg-4">
                    ...
                    <input type="text" name="alcance" id="alcance" class="form-control" value="{{ $optionsScope['municipal'] }}" readonly>
