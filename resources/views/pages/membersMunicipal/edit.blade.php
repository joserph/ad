...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        ...
        <div class="row align-items-center" bis_skin_checked="1">
            ...
            <h4 class="fw-semibold mb-8">@if($member->id) Editar Comite Ejecutivo Municipal @else Registrar Miembros @endif</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ route('members-municipal.index') }}">Comite Ejecutivo Municipales</a>
                    </li>
    ...
    <div class="card">
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members-municipal.update', $member->id) }}">
                @csrf
                @method('PUT')
                ...
                <!-- Parroquia -->
                {{-- <div class="mb-3 col-md-6 col-lg-4 @if($member->parroquia == '') d-none @endif"">
                    ...
                    {{-- <select class="form-control select2 @error('cargo') is-invalid @enderror"
                        ...
                        <option value="">Seleccionar</option>
                            @foreach ($optionsPositions as $value => $label)
                                <option value="{{ $value }}" @if ($member->cargo === $value) selected @endif >{{ $label }}</option>";
                            @endforeach
                    </select> --}}
                    @error('cargo')
                        <div class="invalid-feedback">{{ $message }}</div>
