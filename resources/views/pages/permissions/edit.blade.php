...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        <div class="card-body px-4 py-3" bis_skin_checked="1">
            ...
            <div class="col-9" bis_skin_checked="1">
                <h4 class="fw-semibold mb-8">Editar Permiso</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form class="row" method="POST" action="{{ route('permissions.update', $permission) }}">
                @csrf
                @method('PUT')
                <div class="mb-3 col-md-6 col-lg-4">
                    <label for="" class="form-label">Nombre</label>
                    <input type="text" class="form-control" name="name" id="" value="{{ $permission->name }}" required>
                    @error('name')
