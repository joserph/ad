...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4" bis_skin_checked="1">
        ...
        <div class="row align-items-center" bis_skin_checked="1">
            ...
            <h4 class="fw-semibold mb-8">@if($member->id) Editar Comite Ejecutivo Seccional @else Registrar Miembros @endif</h4>
    ...
    <div class="card">
        <div class="card-body position-relative">
            ...
            <form class="row" method="POST" action="{{ route('members-seccional.update', $member->id) }}">
                @csrf
                @method('PUT')
                ...
                <!-- Municipio -->
                {{-- <div class="mb-3 col-md-6 col-lg-4 @if($member->municipio == '') d-none @endif">
